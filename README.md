...
The framework combines one base learner and several meta-learners into a stacked ensemble model and identifies biologically meaningful genes that contribute to clinical analysis of the gene's relationship with specific cancer types.
...
3. src/
 - Contains the core implementation of the project, including:
    - Training base machine learning models (e.g., Support Vector Machines)
    - Building stacked ensemble models
    - Performing feature selection
    - Mapping selected genes to biological pathways for interpretation
4. results/
